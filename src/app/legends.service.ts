...
export class LegendsService {
  ...
  legends: Legend[] = [
    ...
    { name: 'ricoverati_con_sintomi', checked: true, label: $localize`Hospitalized`, color: '#aFb3F5'},
    ...
    { name: 'nuovi_ricoverati_con_sintomi', checked: true, label: $localize`Hospitalized`, color: '#aFb3F5'},
    { name: 'nuovi_terapia_intensiva', checked: true, label: $localize`Intensive Care`, color: '#cb99c9' },
    { name: 'totale_nuovi_casi_nuovi_casi_testati', checked: true, label: $localize`Daily Cases per People Tested`, color: '#aae3f5' },
  ];
